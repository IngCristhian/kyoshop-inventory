-- KYOSHOP INVENTORY SYSTEM - PRODUCTION
-- Script de creación de base de datos para producción
-- Ejecutar este script en phpMyAdmin o terminal MySQL

CREATE DATABASE IF NOT EXISTS kyosankk_inventory 
CHARACTER SET utf8mb4 
COLLATE utf8mb4_unicode_ci;

USE kyosankk_inventory;
