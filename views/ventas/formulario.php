        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formNuevoCliente">
                    <div class="mb-3">
                        <label for="nuevo_nombre" class="form-label fw-bold">Nombre Completo *</label>
                        <input type="text" class="form-control" id="nuevo_nombre" required>
                    </div>
                    <div class="mb-3">
                        <label for="nuevo_telefono" class="form-label fw-bold">Teléfono *</label>
                    ...
                    <div class="mb-3">
                        <label for="nuevo_ciudad" class="form-label fw-bold">Ciudad</label>
